...
The filtered dataset is available [here](https://drive.google.com/file/d/17rQSS01VLlYUuP3VfmfBMw5_4CZLGvnM/view?usp=drive_link). This dataset is the result of filtering the previous dataset with the [`keyword_string`](/keyword_string.py) and piloting some outcomes. After unzipping the file, you will find a CSV file with the following fields:
