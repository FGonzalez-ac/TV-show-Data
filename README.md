...
The filtered dataset containing the topic modeling results ('topic' field) is available [here](). This dataset is the result of filtering the previous dataset with the [scoping keyword string](docs/keywords).
